...
class TPUART2SerialLayer2Driver:public Layer2Interface, private Thread
{
  /** old serial config */
...
public:
    TPUART2SerialLayer2Driver (const char *dev, eibaddr_t addr, int flags,
			      Trace * tr);
   ~TPUART2SerialLayer2Driver ();
  bool init ();
